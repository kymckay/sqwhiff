...
void Parser::eat(TokenType type) {
  if (current_token_.type == type) {
    ...
    throw sqwhiff::SyntaxError(
        current_token_.line, current_token_.column, current_token_.file,
        "Unexpected token '" + current_token_.raw + "', expected " +
            SQF_Token_Descriptors.at(type));
  }
}
